...
public class CodeGenerator2 {
    public static void main(String[] args) {
        ...
        FastAutoGenerator.create(url, username, password)
                ...
                .templateConfig(builder -> {
                    builder.disable()
                            .entity("templates/repostitory.java");
                })
    ...
    private static void checkTemplates(String projectPath) {
        ...
        if (dir.exists()) {
            ...
            // 检查关键模板文件
            String[] requiredTemplates = {"repository.java.ftl"};
    ...
    private static void cleanOldFiles(String projectPath, String tableName) {
        ...
        String[] filesToDelete = {
                projectPath + "/src/main/java/org/goodday1/mybatis/repository/" + entityName + "Repository.java"
        };
